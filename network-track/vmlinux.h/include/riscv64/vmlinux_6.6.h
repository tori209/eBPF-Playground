...
enum vm_event_item {
	...
	DROP_SLAB = 44,
	OOM_KILL = 45,
	UNEVICTABLE_PGCULLED = 46,
	UNEVICTABLE_PGSCANNED = 47,
	UNEVICTABLE_PGRESCUED = 48,
	UNEVICTABLE_PGMLOCKED = 49,
	UNEVICTABLE_PGMUNLOCKED = 50,
	UNEVICTABLE_PGCLEARED = 51,
	UNEVICTABLE_PGSTRANDED = 52,
	NR_VM_EVENT_ITEMS = 53,
};
...
struct arch_vdso_data {
	__u64 all_cpu_hwprobe_values[6];
...
struct mm_struct {
	struct {
		...
		long unsigned int saved_auxv[64];
